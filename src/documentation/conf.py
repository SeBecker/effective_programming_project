...
project = u'Replication - Income and Democracy by Acemoglu, Johnson, Robinson and Yared'
copyright = u'2013-, Sebastian Becker'
...
latex_documents = [(
    ...
    'Documentation of the Replication - Income and Democracy by Acemoglu, Johnson, Robinson and Yared project',
    'Sebastian Becker',
    'manual'
)]
